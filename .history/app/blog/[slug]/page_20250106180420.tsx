...
// Định nghĩa kiểu dữ liệu cho đối tượng blogPosts
interface BlogPosts {
  [key: string]: BlogPost; // Index signature để cho phép truy cập bằng bất kỳ chuỗi nào
}

// Đối tượng blogPosts với index signature
...
export default function BlogPost({ params }: { params: { slug: string } }) {
  // Kiểm tra xem slug có tồn tại trong blogPosts không
