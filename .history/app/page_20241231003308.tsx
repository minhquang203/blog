...
export default function Home() {
  ...
  const skills = [
    ...
    { name: "Backend Development", level: 70, icon: Server },
    { name: "Database Management", level: 60, icon: Database },
    { name: "Cloud Services", level: 50, icon: Cloud },
    { name: "DevOps", level: 40, icon: Cog },
  ];
  ...
  const projects = [
    {
      title: "HomeStayMove",
      description:
        "A platform to find and book homestays around the world.",
      image: "/homestaymove.jpg?height=400&width=600", // Đảm bảo rằng bạn đã đặt hình ảnh này trong thư mục public
