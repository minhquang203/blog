...
export default function Home() {
  ...
  const skills = [
    { name: "Frontend Development", level:80, icon: FaCode },
    { name: "Backend Development", level: 70, icon: FaServer },
    { name: "Database Management", level: 60, icon: FaDatabase },
    { name: "Cloud Services", level: 50, icon: FaCloud },
    { name: "DevOps", level: 40, icon: FaCoga },
  ];
  ...
  const projects = [
    {
      ...
      description:
        "Real-time data analytics platform with machine learning capabilities",
